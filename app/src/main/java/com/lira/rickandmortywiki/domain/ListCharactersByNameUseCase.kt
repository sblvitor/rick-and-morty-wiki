...
class ListCharactersByNameUseCase(private val repository: CharacterRepository): UseCase<String, Response<CharacterList>>() {

    override suspend fun execute(param: String): Flow<Response<CharacterList>> {
        return repository.listCharacterByName(param)
    }
